...
const RULE_TYPE_INFO: Record<string, { label: string; description: string }> = {
  COVERAGE_EXCLUSION: {
    ...
    description: 'El hecho generador denunciado no está entre los que cubre la cobertura contratada.',
  },
  POLICY_IN_FORCE: {
  ...
  REPORT_DEADLINE: {
    ...
    description: 'La denuncia se presentó fuera del plazo que la cobertura le da al asegurado para avisar del hecho.',
  },
  POLICE_DEADLINE: {
  ...
  MAX_EVENTS_YEAR: {
    ...
    description: 'El asegurado superó la cantidad máxima de siniestros del ramo en los últimos 12 meses.',
  },
  POLICY_STANDING: {
  ...
  FRAUD_RECORD: {
    ...
    description: 'El asegurado tiene un antecedente de fraude dentro de la ventana configurada por la aseguradora.',
  },
  COVERS_FAMILY_GROUP: {
    label: 'Alcance familiar de la cobertura',
    description: 'El damnificado no es el titular ni el grupo familiar conviviente que alcanza la cobertura.',
  },
  ...
  FT_AMOUNT_RATIO: {
    ...
    description: 'El monto reclamado supera el porcentaje de la suma asegurada que habilita el trámite rápido.',
  },
  FT_PRIOR_CLAIMS: {
    label: 'Fast Track: siniestros previos',
    description: 'El asegurado superó la cantidad de siniestros previos que admite el trámite rápido.',
  },
  FT_POLICY_AGE: {
