...
BEGIN
    ...
    EXECUTE format($ddl$
        CREATE TABLE %I.coverage (
            ...
            deductible                      NUMERIC(15,2),           -- franquicia
    ...
    -- so each insurer calibrates its own weights and bands without a redeploy.
    EXECUTE format($ddl$
    ...
    EXECUTE format($ddl$
        INSERT INTO %I.scoring_configuration (id, name, active) VALUES
