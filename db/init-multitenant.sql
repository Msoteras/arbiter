...
BEGIN
    ...
    -- db/datos-aseguradoras.sql). Eso vive en policy_coverage, abajo.
    EXECUTE format($ddl$
    ...
    EXECUTE format($ddl$
        CREATE TABLE %I.case_settlement (
            ...
            -- Qué fórmula se aplicó. Hoy solo pérdida total; la reparación por daño
            -- en tentativa de robo entra acá como segundo literal.
