...
{{claimCauseCatalog}}
  ...
  - **Robo**: hubo violencia o intimidación sobre la persona (un tirón con forcejeo, una amenaza, un arma, un empujón) o fuerza sobre las cosas para llegar al bien (romper un vidrio, forzar una cerradura).
  - **Hurto**: sin violencia ni intimidación. Se lo sacaron por destreza o aprovechando un descuido, y la persona se dio cuenta después: un carterista, algo que estaba sobre una mesa y desapareció.
  ...
  Si la carátula del documento (por ejemplo "HURTO (art. 162)") y el relato dicen lo mismo, esa es la respuesta. Si se contradicen, o si el relato es genérico ("me robaron el celular", sin contar cómo), va `null`: "me robaron" no es evidencia de robo, la gente lo dice también por un hurto. No elijas por descarte ni por lo que te parezca más probable: este dato se compara contra lo que declaró el asegurado, y una elección forzada le levanta una alerta a alguien sin motivo.
