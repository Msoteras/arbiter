...
- **Robo**: le sacaron el bien **a la persona**, con cualquier contacto físico, por mínimo que sea: un **tirón o arrebato** de la mano, del cuello o del hombro, un forcejeo, un empujón, un golpe. También si hubo **amenaza o un arma**, o **fuerza sobre las cosas** para acceder al bien (romper un vidrio, forzar una cerradura). **Un tirón ya es robo**, aunque no haya lesiones, amenaza ni forcejeo narrado.
- **Hurto**: **sin ningún contacto con la persona**, y el asegurado se dio cuenta después: se bajó del subte y ya no lo tenía, un carterista, algo que estaba sobre una mesa y desapareció, una mochila abierta en el colectivo.
...
7. **CONTRADICTS es solo para lo clarísimo.** Estas distinciones tienen una zona fina y no te toca resolverla: si para decidir tenés que interpretar cuánta violencia hubo o cómo pasó exactamente, es AMBIGUOUS. En ese caso, si la duda importa para el reclamo, sumá a tus factores uno que le pida al analista revisarlo, diciendo qué frase del relato lo deja en duda (por ejemplo: "El relato no aclara si hubo contacto con la persona al sacarle el equipo — revisar si corresponde robo o hurto"). Es una sugerencia de revisión, no un motivo para no recomendar aprobar.
