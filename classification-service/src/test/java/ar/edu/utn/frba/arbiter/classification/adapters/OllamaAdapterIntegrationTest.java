 ...
 *
 * Local:  mvn -pl classification-service test -Dgroups=integracion
...
class OllamaAdapterIntegrationTest extends AbstractPersistenceIT {
    ...
    void classifyMobileTheft_shouldReturnValidClassification() {
        ...
        ClassificationResponse response = claimClassifier.classify(request);
