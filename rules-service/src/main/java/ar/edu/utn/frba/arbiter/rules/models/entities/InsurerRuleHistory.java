...
/**
 * Append-only audit trail of changes to an {@link InsurerRule}. {@code changedBy} is a FK to the
 * tenant's {@code insurer_referent}; null when the actor had no referente profile.
 */
@Entity
