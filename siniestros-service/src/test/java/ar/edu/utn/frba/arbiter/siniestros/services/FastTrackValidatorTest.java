...
class FastTrackValidatorTest {
    ...
    private DenunciaSiniestro claim(BigDecimal claimedAmount) {
    ...
    private PolizaAsegurado policy(boolean upToDate) {
        return PolizaAsegurado.builder()
                .policyNumber("POL-CEL-2024-001")
    ...
    private HistorialAsegurado history(int previousClaimsCount) {
        return HistorialAsegurado.builder()
                .insuredId("40.123.456")
