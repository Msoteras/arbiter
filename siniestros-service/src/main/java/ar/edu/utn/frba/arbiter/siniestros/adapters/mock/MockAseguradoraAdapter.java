...
import ar.edu.utn.frba.arbiter.siniestros.dto.HistorialAsegurado.ClaimRecord;
import ar.edu.utn.frba.arbiter.siniestros.dto.PolizaAsegurado;
import ar.edu.utn.frba.arbiter.siniestros.dto.PolizaAsegurado.PolicyCoverage;
...
public class MockAseguradoraAdapter implements AseguradoraAdapter {
    ...
    private static final Map<String, PolizaAsegurado> POLICIES = Map.of(
    ...
    private static final Map<String, HistorialAsegurado> HISTORIES = Map.of(
    ...
    @Override
    public PolizaAsegurado getPolicy(String policyNumber) {
    ...
    @Override
    public HistorialAsegurado getHistory(String insuredId) {
